...
class NoEnvLabelsScene(Scene):
    def construct(self):
        ...
        # Draw 3 Sources with Tag Colors (Shifted UP * 2.4 to make room)
        source_a = VGroup(
        ...
        # Create small colored dots inside/below sources
        ...
        # Draw a pooling funnel (Shifted UP to prevent bottom overlap)
        ...
        # Animate dots falling through the funnel and merging below as gray dots
        pooled_cloud_center = DOWN * 1.2
        
        # Target positions for gray dots
        import numpy as np
        np.random.seed(33)
        ...
        # Run anim: all colored dots slide into funnel, then transform to gray dots below
        self.play(
            # Move dots to funnel throat (positioned nicely in funnel mouth)
