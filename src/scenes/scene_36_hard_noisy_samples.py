...
class HardNoisySamplesScene(Scene):
    def construct(self):
        ...
        # 1. Creative Intro: warning triangle rotation morphing intro
        triangle_points = [UP * 1.5, LEFT * 1.7 + DOWN * 1.2, RIGHT * 1.7 + DOWN * 1.2, UP * 1.5]
        ...
        play_voiceover_and_wait(self, 36, 0)
        ...
        # seg 1: "ta thường tập trung vào mẫu loss cao như DRO..."
        play_voiceover_and_wait(self, 36, 1)
        ...
        # seg 2: "đây là nhóm đa số, loss thấp..."
        play_voiceover_and_wait(self, 36, 2)

        # Subtitle 2
        sub2 = create_bottom_caption("Nhưng các điểm có loss cao có thể đến từ hai nguồn rất khác nhau.")
        self.play(Transform(sub1, sub2))
        # seg 3: "các điểm loss cao đến từ hai nguồn khác nhau..."
        play_voiceover_and_wait(self, 36, 3)

        # Minority/Hard Cluster (Green) + Outlier/Noisy (Red)
        hard_dots = VGroup(*[
        ...
        self.play(Create(ring_hard), Create(ring_noisy), Write(high_loss_text), run_time=TIME_NORMAL)
        # seg 4: "cả cụm thiểu số lẫn điểm ngoại lai đều loss cao như nhau..."
        play_voiceover_and_wait(self, 36, 4)
        ...
        # seg 5: "trường hợp 1 là hard samples đáng tối ưu..."
        play_voiceover_and_wait(self, 36, 5)
        ...
        # seg 6: "trường hợp 2 chỉ là noisy cô lập, cố fit sẽ học nhiễu..."
        play_voiceover_and_wait(self, 36, 6)
        ...
        # seg 7: "loss cao là tín hiệu không rõ ràng..."
        play_voiceover_and_wait(self, 36, 7)
