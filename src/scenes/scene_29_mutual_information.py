...
class MutualInformationScene(Scene):
    def construct(self):
        ...
        play_voiceover_and_wait(self, 29, 0)
        ...
        # seg 1: "Mutual information đo lượng thông tin..."
        play_voiceover_and_wait(self, 29, 1)
        ...
        # seg 2: "H của Y là entropy... hình chữ nhật vàng..."
        play_voiceover_and_wait(self, 29, 2)
        ...
        # seg 3: "Bây giờ quan sát X. H(Y|X) là bất định còn lại..."
        play_voiceover_and_wait(self, 29, 3)
        ...
        # seg 4: "Phần xanh dương là H(Y|X), phần xanh lá là mutual information..."
        play_voiceover_and_wait(self, 29, 4)
        ...
        # seg 5: "Công thức I = H(Y) - H(Y|X)..."
        play_voiceover_and_wait(self, 29, 5)
        ...
        # seg 6: "Thông tin chính là sự giảm thiểu bất định..."
        play_voiceover_and_wait(self, 29, 6)
