...
class COVIDMortalityScene(Scene):
    def make_feature_panel(self, title_text, values, bar_color, center_pos):
        ...
        box = RoundedRectangle(
            ...
            corner_radius=0.1, stroke_color=TEXT_MUTED, stroke_width=1.5,
            fill_color=BG_PANEL, fill_opacity=0.75
        )
    ...
    def construct(self):
        ...
        ecg_points = [
            LEFT * 5 + DOWN * 0.5, LEFT * 1 + DOWN * 0.5, LEFT * 0.7 + DOWN * 1.0,
            LEFT * 0.4 + UP * 1.8, LEFT * 0.1 + DOWN * 1.4, RIGHT * 0.2 + DOWN * 0.5,
            RIGHT * 5 + DOWN * 0.5
        ]
        ...
        play_voiceover_and_wait(self, 32, 0)
        ...
        # seg 1: "ERM chỉ thấy đặc trưng rủi ro trung bình..."
        play_voiceover_and_wait(self, 32, 1)
        ...
        # seg 2: "đây là các đặc trưng quan trọng theo góc nhìn trung bình..."
        play_voiceover_and_wait(self, 32, 2)
        ...
        # seg 3: "khi phân tách subpopulation, hai cơ chế khác biệt lộ ra..."
        play_voiceover_and_wait(self, 32, 3)
        ...
        # seg 4: "nhóm cao tuổi - bệnh nền; nhóm cộng đồng - triệu chứng..."
        play_voiceover_and_wait(self, 32, 4)
        ...
        self.play(FadeIn(glow_sub1), FadeIn(glow_sub2), run_time=TIME_NORMAL)
        # seg 5: "mỗi nhóm có đặc trưng chủ đạo riêng, ERM làm mờ cả hai..."
        play_voiceover_and_wait(self, 32, 5)
        ...
        # seg 6: "một dataset có thể chứa nhiều cơ chế rủi ro..."
        play_voiceover_and_wait(self, 32, 6)
