...
class DeductiveInductiveScene(Scene):
    ...
    def construct(self):
        ...
        play_voiceover_and_wait(self, 26, 0)
        ...
        # seg 1: "Ta nên bắt đầu từ method hay hiện tượng..."
        play_voiceover_and_wait(self, 26, 1)
        ...
        # seg 2: "Hướng diễn dịch — xuất phát từ lý thuyết..."
        play_voiceover_and_wait(self, 26, 2)
        ...
        # seg 3: "Bước 1 giả định, Bước 2 thiết kế, Bước 3 áp dụng..."
        play_voiceover_and_wait(self, 26, 3)
        ...
        # seg 4: "Hướng quy nạp đi ngược lại, bắt đầu từ lỗi thực tế..."
        play_voiceover_and_wait(self, 26, 4)
        ...
        # seg 5: "Từ lỗi thực tế, phân tích shift, thiết kế giả định, chọn method..."
        play_voiceover_and_wait(self, 26, 5)
        ...
        # seg 6: "Phương pháp quy nạp thực tiễn hơn..."
        play_voiceover_and_wait(self, 26, 6)
        ...
        # seg 7: "Bắt đầu từ các dịch chuyển quan sát được..."
        play_voiceover_and_wait(self, 26, 7)
