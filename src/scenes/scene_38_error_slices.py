...
class ErrorSlicesScene(Scene):
    ...
    def construct(self):
        ...
        # 1. Creative Intro: horizontal box slicing/sliding animation
        ...
        play_voiceover_and_wait(self, 38, 0)

        self.play(
            FadeOut(slice_left), FadeOut(slice_mid), FadeOut(slice_right),
            FadeOut(title_group), FadeOut(subtitle_text),
            run_time=TIME_FAST
        )
        ...
        # seg 1: "độ chính xác trung bình 95% có thể che giấu lỗi nghiêm trọng..."
        play_voiceover_and_wait(self, 38, 1)
        ...
        # seg 2: "đây là độ chính xác tổng thể 95%..."
        play_voiceover_and_wait(self, 38, 2)
        ...
        self.play(ReplacementTransform(overall_panel, VGroup(s1, s2, s3)), run_time=TIME_SLOW)
        # seg 3: "phân tách thành error slice: A 99, B 93, C chỉ 43%..."
        play_voiceover_and_wait(self, 38, 3)
        ...
        # seg 4: "nhóm C thiểu số 5% nhưng thất bại nặng, lát cắt tệ nhất..."
        play_voiceover_and_wait(self, 38, 4)
        ...
        # seg 5: "tìm nơi model thất bại, không chỉ tần suất..."
        play_voiceover_and_wait(self, 38, 5)
