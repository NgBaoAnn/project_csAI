...
class ColoredMNISTScene(Scene):
    def construct(self):
        ...
        for i, sq in enumerate(pixels):
            ...
            disintegrate_anims.append(sq.animate.move_to(sq.get_center() + direction * dist).set_opacity(0))
        ...
        self.play(*disintegrate_anims, FadeIn(title_group, scale=0.9), Write(subtitle_text), run_time=1.5)
        # seg 0: Title introduction
        play_voiceover_and_wait(self, 35, 0)
        self.play(FadeOut(title_group), FadeOut(subtitle_text), FadeOut(pixels), run_time=TIME_FAST)

        # Subtitle 1
        sub1 = create_bottom_caption("ColoredMNIST là benchmark kinh điển để kiểm chứng spurious correlation.")
        self.play(FadeIn(sub1))
        # seg 1: "ColoredMNIST minh họa spurious correlation..."
        play_voiceover_and_wait(self, 35, 1)
        ...
        # seg 2: "trong train, 90% số 5 màu xanh, màu giúp dự đoán dễ..."
        play_voiceover_and_wait(self, 35, 2)
        ...
        # seg 3: "mô hình học shortcut: thấy xanh thì đoán 5..."
        play_voiceover_and_wait(self, 35, 3)
        ...
        # seg 4: "ở test, tương quan đảo ngược: số 5 giờ màu đỏ..."
        play_voiceover_and_wait(self, 35, 4)
        ...
        # seg 5: "shortcut màu sụp đổ, mô hình dự đoán sai..."
        play_voiceover_and_wait(self, 35, 5)
        ...
        # seg 6: "chỉ khi học shape bất biến mô hình mới robust..."
        play_voiceover_and_wait(self, 35, 6)
        ...
        # seg 7: "đặc trưng màu giả thất bại khi environment đổi..."
        play_voiceover_and_wait(self, 35, 7)
